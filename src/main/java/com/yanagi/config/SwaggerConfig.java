...
public class SwaggerConfig {
    ...
    public Docket createApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.yanagi.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("健康运动管理平台")
                .version("1.0.0")
                .contact(new Contact("柳成林", "http://localhost:8080/doc.html", "2947140558@qq.com"))
                .description("健康运动管理平台接口文档")
                .build();
    }
